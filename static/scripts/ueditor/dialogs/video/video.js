...
(function(){
    ...
    function convert_url(url){
        ...
        url = utils.trim(url)
            ...
            .replace(/.+?\.qq\.com\/.+?\.html?.+?vid=([\w]+)(&.+)?/i, "http://v.qq.com/iframe/player.html?vid=$1&amp;auto=0")
            .replace(/v\.qq\.com\/.+\/([\w]+)\.html$/i, "v.qq.com/iframe/player.html?vid=$1&amp;auto=0")
            .replace(/v\.qq\.com\/cover\/[\w]+\/[\w]+\.html?vid=([\w]+)/i, "v.qq.com/iframe/player.html?vid=$1&amp;auto=0")
        ...
        //http://v.qq.com/iframe/player.html?vid=u0100zvfnxt&amp;auto=0
        // http://v.qq.com/x/page/z0319ezsea5.html
        //http://cache.tv.qq.com/clientportal/v9_6/main.html?cid=x&vid=n0310j4ozgw 
        //http://v.qq.com/page/w/1/5/w01002z2j15.html
        return url;
    }
    ...
    function getVideoHtml(url){
    	...
    	var conUrl = convert_url(url);
    	return '<section class="135editor" >'+
        '<section style="text-align:center;"><iframe class="video_iframe"  style="position: relative;z-index:1;height:240px;width:320px;"  scrolling="no" src="'+conUrl+'" allowfullscreen="" frameborder="0" ></iframe></section>'+
        '<p class="135brush" data-brushtype="text" style="text-align:center;">视频名称</p></section>'
    }
    ...
    function createPreviewVideo(url){
        ...
        //<iframe style="   z-index:1; " src="http://v.qq.com/iframe/player.html?vid=u0100zvfnxt&amp;auto=0" allowfullscreen="" frameborder="0" height="200" width="300"></iframe>
