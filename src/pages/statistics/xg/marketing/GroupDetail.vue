<template>
  <div class="m20 groupDetail">
    <bread-crumb :initBread="breadList" isBack></bread-crumb>
    <div class="common-section role-manage">
      <!-- <el-breadcrumb separator-class="el-icon-arrow-right" style="padding: 8px 16px;">
        <el-breadcrumb-item :to="{ path: '/xg/marketing/group' }">集团图文统计</el-breadcrumb-item>
        <el-breadcrumb-item>集团图文详情</el-breadcrumb-item>
      </el-breadcrumb> -->
...
export default {
  data() {
    return {
      ...
      contentDialog: false,
      content: "",
      breadList: [{"name": '集团图文统计','path': '/xg/marketing/group'},{"name": '图文详情','path': ''}]
    };
  },
  created() {
    this.params = {
  ...
  methods: {
    getRoleData() {
      ...
      Http.getGroupDetail(this.$route.query.id, this.params)
        .then(res => {
          this.loading = false;
    ...
    configExportFn() {
      ...
      params.export = 1; // 导出
        ...
        // 导出传递所需参数
        this.configExport = {
          url: "/template/statistics/" + this.$route.query.id,
          params: params,
          filename: "集团图文统计详情"
        };
    },
...
<style lang="scss" scoped>
  .groupDetail /deep/.preview-body img{
    max-width: 760px;
  }
</style>
